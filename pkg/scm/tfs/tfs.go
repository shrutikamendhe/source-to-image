...
// repository
func (h *stiTfs) ValidCloneSpec(source string) bool {
...
func (h *stiTfs) ValidCloneSpecRemoteOnly(source string) bool {
...
// since the URL is
func (h *stiTfs) MungeNoProtocolURL(source string, uri *url.URL) error {
	if uri == nil {
		return nil
	}
...
func (h *stiTfs) Clone(source, target string, c api.CloneConfig) error {
...
func (h *stiTfs) Checkout(repo, ref string) error {
...
func (h *stiTfs) SubmoduleInit(repo string) error {
	opts := util.CommandOpts{
		Stdout: os.Stdout,
		Stderr: os.Stderr,
		Dir:    repo,
...
func (h *stiTfs) SubmoduleUpdate(repo string, init, recursive bool) error {
...
func (h *stiTfs) GetInfo(repo string) *api.SourceInfo {
